...
public class AsociadosController extends AcoasmiController<Asociados, AsociadosRequestDTO, AsociadosResponseDTO, Long> {
    ...
    @Operation(summary = "Buscar por número de asociado", description = "Retorna la información del asociado utilizando su código correlativo único.")
    ...
    @Operation(summary = "Buscar por documento (DUI)", description = "Permite ubicar a un asociado mediante su número único de identidad.")
    ...
    @Operation(summary = "Buscar por NIT", description = "Busca al asociado a través de su identificación tributaria.")
    ...
    @Operation(summary = "Buscar por correo electrónico", description = "Encuentra al asociado mediante su dirección de email registrada.")
    ...
    @Operation(summary = "Listar filtrado por estado", description = "Retorna un listado paginado de asociados activos (true) o inactivos (false).")
    ...
    @Operation(summary = "Buscador predictivo global", description = "Filtra asociados de forma paginada que coincidan parcialmente con nombres, apellidos o número de documento.")
