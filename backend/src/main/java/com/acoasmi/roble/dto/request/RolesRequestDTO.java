...
public class RolesRequestDTO {
    ...
    @Schema(description = "Nombre único del rol en el sistema", example = "Cajero, Administrador, Contador")
    private String rol;
    ...
    @Schema(
            description = "Listado de nombres descriptivos de los permisos asignados a este rol",
            example = "[\"CREAR_USUARIOS\", \"APERTURAR_CAJA\", \"CREAR_SOLICITUD_CREDITO\"]"
    )
